...
export const PlaceholderPage: React.FC<PlaceholderPageProps> = ({ title }) => {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center bg-white rounded-2xl border border-border-color shadow-sm">
      ...
      <p className="mt-2 text-secondary-text">
        Este módulo está em desenvolvimento. Volte em breve!
      </p>
    </div>
  );
};
