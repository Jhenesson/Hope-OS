...
export const LeadsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M17.2 13.2a4.5 4.5 0 0 0-4.5-4.5h-5a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h8.5a2.5 2.5 0 0 0 1.8-4.2Z" />
    <path d="M12.5 8.8a4.5 4.5 0 0 0 4.5 4.5h.5a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-3a2.5 2.5 0 0 0-1.8 4.2Z" />
  </svg>
);

export const RecordingsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const CampaignsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M10.4 2.2a2.3 2.3 0 0 1 3.2 0l8.1 8.1a2.3 2.3 0 0 1 0 3.2l-8.1 8.1a2.3 2.3 0 0 1-3.2 0l-8.1-8.1a2.3 2.3 0 0 1 0-3.2Z" />
    <path d="m14 10-4 4" />
    <path d="m10 10 4 4" />
  </svg>
);
...
export const HopeOSLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const RocketIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M9 12H4s.55-3.03 2-4c1.62-1.1 4-1 4-1s.25 1.84 1 3.25"></path>
        <path d="M12 9v5c3.03-1.45 4-2 4-2s1.1 2.38 0 4c-1.1 1.62-4 2-4 2"></path>
    </svg>
);
